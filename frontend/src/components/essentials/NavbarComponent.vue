      ...
      <transition name="slide-right">
        ...
        >
          <nav class="flex flex-col gap-6 text-lg">
            <a href="/home" @click="toggleMobileMenu">{{
            ...
            >
              <span>{{
                localIsDark
                  ? $t("message.navbar.cog_darkmode_mobile")
                  : $t("message.navbar.cog_lightmode_mobile")
              }}</span>
            </button>

            <!-- Locale toggle -->
            <div
              @click="switchLocaleTo('_')"
              class="flex items-center gap-3 cursor-pointer"
            >
              <span>{{
                locale === "en"
                  ? $t("message.navbar.language_english_mobile")
                  : $t("message.navbar.language_indonesian_mobile")
              }}</span>
            </div>
          </nav>
        </div>
